...
def Route7(laura: Laura):
    ...
    laura.wall_square(-35,300,0)
    laura.encoder_degree(70,70,1200,True)
    laura.gyro_point_turn(-40,True,10,20)
    laura.encoder_degree(50,50,200,True)
    laura.adapter_motor_seconds()
