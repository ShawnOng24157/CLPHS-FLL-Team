...
def Route1(laura: Laura):
    ...
    laura.adapter_motor_seconds(RIGHT_ADAPTER, -1000, 1400, Stop.BRAKE, False)
    ...
    laura.adapter_motor_degree(RIGHT_ADAPTER, -1000, 350, wait_complete=False)
    laura.gyro_time(-50, 500, -180)
    laura.gyro_acc(70, 12, -180)
    laura.encoder_degree(-70, 70, 165)
    laura.adapter_motor_seconds(RIGHT_ADAPTER, 1000, 1700, wait_complete=False)
    wait(500)
    laura.encoder_time(45, 55, 1300)
    laura.gyro_degree(-40, 15, -270)
    laura.adapter_motor_seconds(RIGHT_ADAPTER, -600, 1450)
    wait(200)
    ...
    laura.adapter_motor_seconds(RIGHT_ADAPTER, -1000, 1900, Stop.COAST, False)
    laura.encoder_degree(-70, -70, 440, False)
    laura.gyro_lock_turn(LEFT_DRIVE, -192)
    laura.adapter_motor_degree(RIGHT_ADAPTER, 1000, 120, True, Stop.BRAKE, False)
    wait(300)
    laura.gyro_acc(80, 620, -192)
