...
def Route1(laura: Laura):
    ...
    wait(500)
    laura.encoder_time(45, 55, 1700)
    laura.gyro_degree(-40, 15, -270)
    laura.adapter_motor_seconds(LEFT_ADAPTER, -600, 1450)
    wait(200)
    laura.adapter_motor_seconds(LEFT_ADAPTER, 800, 400, Stop.COAST, False)
    wait(900)
    laura.encoder_degree(-60, -60, 55)
    laura.adapter_motor_seconds(RIGHT_ADAPTER, 1000, 800)
    laura.encoder_degree(-60, -60, 45, False)
